...
export class CheckoutPaymentComponent implements AfterViewInit, OnDestroy {
  ...
  ngAfterViewInit(){
    this.stripe = Stripe("pk_test_51IhR8AH7pehvbGLwJOABIMB9aE0JIutwHdetxkHRDsW8cI9bNJVDvrbj4qRy7imLnD1AXmqoCfknJ2PXRi03FeWQ00wKi9xE9L");
...
onChange(event){
  ...
  private getOrderToCreate<IOrderToCreate>(basket: IBasket){
